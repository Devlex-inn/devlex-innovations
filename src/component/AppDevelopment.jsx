...
const AppDevelopment = () => {
    ...
    return (
        <>
            <div>
                <div className="bg-[url('/images/app-development-bg.png')] bg-no-repeat bg-cover bg-center flex items-center justify-start h-[400px] sm:h-[600px] pt-20">
                        ...
                        <div className="grid grid-cols-3 gap-[50px]">
                            <div className="col-span-3 lg:col-span-2">
                                ...
                                <p className="font-Nunito text-TextColor2-0 mt-6">
                                    At Devlex Innovation, we offer top-notch app development services to help businesses build robust, user-friendly, and scalable applications. Our expert team specializes in mobile and web app development, delivering high-performance solutions tailored to your unique requirements.
                                </p>
                                <p className="font-Nunito text-TextColor2-0 mt-7">
                                    We utilize cutting-edge technologies to develop custom applications, cross-platform solutions, and seamless UI/UX designs that enhance user engagement and business growth. From concept to deployment, we take a strategic approach, ensuring efficiency, security, and scalability at every stage.
                                </p>
                                <p className="font-Nunito text-TextColor2-0 mt-7 mb-11">
                                    Whether you need a feature-rich mobile app, a dynamic web application, or an enterprise-grade solution, we bring your ideas to life with innovation and precision. Partner with Devlex Innovation to create applications that drive success in the digital era.
                                </p>
                                    ...
                                    <div className="flex flex-col md:flex-row lg:flex-col xl:flex-row gap-5 bg-[#f3f4f8] rounded-md px-6 py-7">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="font-Nunito text-TextColor2-0 mt-3">
                                                Smart, scalable, and tailored software to meet your business needs
                                            </p>
                                        </div>
                                    </div>
                                    <div className="flex flex-col md:flex-row lg:flex-col xl:flex-row gap-5 bg-[#f3f4f8] rounded-md px-6 py-7">
                                        <div className="w-[72px] h-[72px] rounded-full bg-white flex justify-center items-center">
                                            <img
                                                src="/images/services-details-icon-3.png"
                                                draggable="false"
                                            />
                                        </div>
                                        <div className="flex-1">
                                            ...
                                            <p className="font-Nunito text-TextColor2-0 mt-3">
                                            High-performance, engaging mobile apps tailored for all devices and platforms
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div className="bg-PrimaryColor-0 px-[42px] rounded-md py-7 flex flex-col sm:flex-row sm:items-center gap-8 mt-[62px]">
                                    ...
                                    <div className="flex-1">
                                        <p className="font-Nunito italic text-lg sm:text-[22px] leading-8 text-white">
                                            Expertly designed app solutions that exceed expectations with seamless integration
                                        </p>
                                    </div>
                                </div>
                                ...
                                <p className="font-Nunito text-TextColor2-0 mt-6">
                                    Unlock seamless, scalable, and high-performance app solutions that enhance user experience,
                                    drive engagement, and accelerate business growth with cutting-edge technology.
                                </p>
